  ...
  return (
    <div className="w-full">
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5 mx-5 place-items-center	">
        {items.map((item) => (
          <div className="bg-red-400 rounded-md shadow-lg overflow-hidden sm:w-full cursor-pointer hover:scale-105 bg-gradient-to-r from-red-500 to-zinc-400 mb-5" key={item.id}>
